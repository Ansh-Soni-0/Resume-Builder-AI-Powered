...
function ColorPicker( { selectedColors , onChange } ) {
  ...
  return (
    <div ref={pickerRef} className="relative">
        ...
        {
            isOpen && ( 
                <div className="grid grid-cols-4 w-60 gap-2 absolute top-full left-0 right-0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm max-h-64 overflow-y-auto custom-scrollbar">
                    {colors.map((color) => (
