...
const ResumeBuilder = () => {
  ...
  const saveResume = async () => {
    try {
      ...
      //reumove image from updatedResume data
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                ...
                <hr className='absolute top-0 left-0 h-1 bg-linear-to-r from-green-400 to-green-600 border-none transition-all duration-2000' style={{width:`${activeSectionIndex * 100 /(sections.length - 1)}%`}}/>

                {/* section navigation  */}
                <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>

                  {/* left side - template selector & colorpicker button   */}
                  <div className='flex items-center gap-2'>
                    <TemplateSelector selectedTamplate={resumeData.template} onChange={(template) => setResumeData(prev => ({...prev , template}))}/>

                    <ColorPicker selectedColors={resumeData.accent_color} onChange={(color) => setResumeData(prev => ({...prev , accent_color:color}))}/> 
                  </div>

                  {/* right - previous and next button*/}
                ...
                className='bg-linear-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring hover:ring-green-500 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                  Save Changes
                </button> 
